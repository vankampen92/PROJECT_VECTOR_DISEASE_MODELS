  ...
  switch(j)
    ...
    case 37:
      ...
      (*value_0) = (0.0);
	      ...
	      break;
    case 38:
              /* Initial Fraction of Recovered (or Cases, for models with cases) */
      (*value_1) = (1.0);
      (*value_0) = (0.0);
    ...
    case 46:
      ...
      (*value_0) = (0.01);
              ...
              break;
    case 47:
      /* H_mSigma - modifier of loss of immunity for SnInR */
      (*value_1) = ( 1.0 );
      ...
      (*value_0) = ( 0.001 );
              ...
              break;
    case 48:
      /* H_mRecov - modifier of recovery from infection for SnInR*/
      (*value_1) = ( 1.0 );
      ...
      (*value_0) = ( 0.001 );
              ...
              break;
    case 49:
              /*H_mBeta - modifier of force of infection for SnInR */
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 50:
              /*H_mM_c - modifier of human infectivity for SnInR */
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 51:
              /*Temperature degrees C (Temp)*/

      (*value_1) = (28.0);  /* Rubby's value 32 oC */

      (*value_0) = (18.0);

              break;
    case 52:
              /* Initial fraction of S1 (s1__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 53:
              /* Initial fraction of I1 (i1__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 54:
              /* Initial fraction of S2 (s2__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 55:
              /* Initial fraction of I2 (i2__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 56:
              /* Initial fraction of S3 (s3__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    case 57:
              /* Initial fraction of I3 (i3__0) - SnInR models*/
      ...
      (*value_0) = (0.0);
              ...
              break;
    // case 52:
    //           /*Time Dependency (for Update_Time_Dependence function in
    //            Definition_Numerical_Integration folder)*/
    //
    //   (*value_1) = (16.0);
    //
    //   (*value_0) = (32.0);
