...
double Euclidean_Distance_between_Two_Positions(position p_1, position p_2)
{
  double Distance;
  Distance = sqrt((p_1.x - p_2.x)*(p_1.x - p_2.x) + (p_1.y - p_2.y)*(p_1.y - p_2.y) );
  return Distance;
}
...
#if defined NUMERICAL_RECIPES
void rank_Abundance_Pop_1_n(int Pop[], int n, double Rank[])
{
