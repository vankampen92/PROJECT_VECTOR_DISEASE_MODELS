/*
   ...
   through treatment do no develop immunity at all, but reenter the susceptible class. This 
   ODE system does NOT keep either track of accummulated cases (A) nor a dynamic carrying 
   capacity (K). 

   2. Time dependent parameter (environmental forcing): Generally implemented through 
      the function deterministic_time_dynamics.c
*/
...
#include <include.ODE_sys_CASES_1.c>

  /* Fraction of infectious humans, f */
  f = (y[I]+y[C]) / P->H; 

#include <include.ODE_sys_LXVnW.c>
