...
<<<<<<< 88be5900082eedfd767e3f965d9e8efe843802c7
<<<<<<< d4c8c210089fb436397cb65efa03b34c9479799b
...
=======
   ...
   M_O_D_E_L___V_A_R_I_A_B_L_E_S___C_O_D_E ( P,
                                             &S_, &E_, &I_, &R_, &C_, &S1_, &I1_, &S2_, &I2_, &S3_, &I3_,
					     &L_, &X_, &U_, &W_,
>>>>>>> Updated model_Variables_Code.h & all calls to include multiple classes (S1, I1, S2, I2, S3, I3)
=======
   int S_; int E_; int I_; int R_; int C_; int S1_; int I1_; int S2_; int I2_; int S3_; int I3_;
   int L_; int X_; int U_; int W_; int A_;
   int K_;
   M_O_D_E_L___V_A_R_I_A_B_L_E_S___C_O_D_E ( P,
                                             &S_, &E_, &I_, &R_, &C_, &S1_, &I1_, &S2_, &I2_, &S3_, &I3_,
					     &L_, &X_, &U_, &W_,
>>>>>>> Initial Conditions update & deterministic time dynamics
					     &A_, &K_ );
 */
					      ...
					      int * K)
{
  ...
  switch( TYPE_of_MODEL )
   ...
   case 13: /* CASES_1-XVnW */
      ...
      /* Mosquito codes */
      (* U) = (* C) + 1;    /************************/                 /* U, first latent mosquito class */
      (* W) = (* C) + 1 + P->n_V;                                     /* W, infectious mosquitos */
      (* X) = (* C) + 1;     /************************/               /* X  is not a dynamic variable */
   ...
   case 23: /* NO_CASES-XVnW */
      ...
      /* Mosquito codes */
      (* U) = (* R) + 1;    /************************/                 /* U, first latent mosquito class */
      (* W) = (* R) + 1 + P->n_V;                                     /* W, infectious mosquitos        */
      (* X) = (* R) + 1;    /************************/               /* X is not a dynamic variable    */
   ...
   case 33: /* SEnI-XVnW */
      ...
      /* Mosquito codes */
      (* U) = (* I) + 1;    /************************/                 /* U, first latent mosquito class */
      (* W) = (* I) + 1 + P->n_V;                                     /* W, infectious mosquitos */
      (* X) = (* I) + 1;     /************************/                 /* X  */
...
/* CLASSES (SnInR) models * * * * * * * * * * * * * * * * * * * * * * */
	 case 51:  /* SnInR-LXVnW */
		   S_n_I_n_R___L_X_U_W___C_O_D_E_S( P,
					 S, E, I, R, C, S1, I1, S2, I2, S3, I3, L, X, U, W );
		   (* C) = (* R); /* Last human class */
		   ...
		   break;
	  case 52: /* SnInR-LXVnW */
		   S_n_I_n_R___X_U_W___C_O_D_E_S( P,
					 S, E, I, R, C, S1, I1, S2, I2, S3, I3, L, X, U, W );
		   (* C) = (* R); /* Last human class */
  ...
  /* Conventionally, the last label in the argument list of M_O_D_E_L___V_A_R_I_A_B_L_E_S___C_O_D_E (...),
     (*K), should be the label of the last model state variable, so that (*K) + 1 becomes de total
     number of dynamic model variables
  */
}
