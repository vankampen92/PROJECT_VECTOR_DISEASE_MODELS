...
/*
   This code calculates two 2D bifurcation diagrams in one go, for two response varibles and the same control model parameter, 
   for instance, a, the bitting rate. This can be changed. See the help for the meaning of -S4 12 (input parameter) and -v0 3 
   (response variable 1) -v1 21 (EIR), as in the exemple below.  
   ...
   Execturion examples: 
        ...
        1. ~$: ./CASES_1-LXVnW_SIMPLE_TWO  -H2 5.4E-5 -H3 6.7E-4 -H4 6.3E-3 -H5 1 -H6 0.05 -H7 0.00001  -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.1  -M0 0.3 -M1 0.1 -M2 0.2 -M3 0.04 -L2 3.0E4 -P0 1 -P1 0.05  -S0 19 -S3 200 -S4 12 -n 2 -v0 3 -v1 21 -G0 1 -G1 2 -G2 0 -G3 0.1 -G4 0.5 -G5 0 -G6 0.0 -G7 200.0 -G8 0 -G9 1 -G10 1 -G11 3 -G12 1 -G27 1 -G28 20 
...
#include "default.c"    
  ...
  int Output_Variable_1 = variable_0;       /* 21: EIR; 3: Fraction of Infectious Humans */
                                            /*  3: Fraction of infectious humans */
                                            /*  5: Number of infectious mosquitoes per human */
  int Output_Variable_2 = variable_1; 
...
#include <gsl_random_number_Setup.c>
  ...
  Status = B_I_F_U_R_C_A_T_I_O_N___D_I_A_G_R_A_M___S_I_M_P_L_E___S_C_A_N( &Table, 
									  No_of_POINTS_1, 
									  Output_Variable_1, 
									  Input_Parameter_1,
									  Epsilon ); 
