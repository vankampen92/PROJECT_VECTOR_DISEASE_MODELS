...
/* This code generates a 3D plot of bifucation curves defined by their 3 branches 
   ...
   the curves creates a proper representation of a surface. 
...
#define No_of_POINTS 50 /* Number of files containing 1D bifurcation curves 
			 * to integrate 
			 */		
...
/* Parse and process command line arguments */
  (void) plparseopts(&argc, argv, PL_PARSE_FULL);
    ...
    sprintf(y_Label, "%s", "Temperature (oC)");
    sprintf(x_Label, "%s", "Carrying Capacity (K)");
