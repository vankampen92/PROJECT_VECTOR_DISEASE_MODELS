...
../CASES_1_$1 -S0 19 -n 3 -v0 3 -v1 21 -v2 30 -G0 1 -G1 3 -t0 200 -t1 0.0 -t2 32400.0  \
...
# CASES_1_LXVnW -S0 19 -n 3 -v0 3 -v1 21 -v2 30 -G0 1 -G1 3 -t0 200 -t1 0.0 -t2 32400.0  -H2 1.4E-4 -H3 6.7E-4 -H4 6.3E-3 -H5 1 -H6 0.05 -H7 0.00001  -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.1  -M1 0.5 -M2 0.2 -M3 0.04 -L2 3.0E4 -P0 1 -P1 0.05 -TP 12 -TY -1 
