...
../$1 -G8 1 -G9 4 -G11 5 -G12 25 -G2 1 -G3 0.0 -G4 3240.0  -G5 0 -G6 0.0 -G7 1.0 -S0 19 -n 3 -v0 21 -v1 23 -v2 30 -G0 1 -G1 3 -t0 200 -t1 0.0 -t2 3240.0 \
...
-TP 12 -TY 0 -T0 0.0 -T1 3240.0 -Ti 1620.0 -M0 0.15 -TI 0.15 -TM 0.45 -TF 0.15  
