...
## SOLUTION SI-XW
../../ODE_RESTRICTED_JACOBIAN_SI-XW_RANDOM_INITIAL_CONDITION_$1 -R0 $2 -S0 19 -n 2 -v0 3 -v1 5 -v2 30 -G0 1 -G1 1 -G5 1 -G6 0.0 -G7 1.0 -t0 4 -t1 0.0 -t2 5000.0  -G8 1 -G9 8 -G10 1 -G11 7 -G12 1 -H1 1.5E-5 -H2 1.5E-5 -H3 6.7E-4 -H4 0.01 -H5 0 -H7 0.00005 -M0 0.33 -M1 0.1 -M2 0.05 -M3 0.05 -M9 0.6 -P0 0   -TP 12 -TY -1  -G14 "\(2748)" # -G14 "Parameter\(2748)space\(2748)exploration:\(2748)dynamical\(2748)regims"
