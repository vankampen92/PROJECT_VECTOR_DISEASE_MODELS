...
##   SOLUTION SEnIRC-LXVnW
### ../../ODE_RESTRICTED_JACOBIAN_CASES_1-LXVnW_RANDOM_INITIAL_CONDITION_$1 -R0 $2 -S0 19 -n 2 -v0 3 -v1 5 -v2 30 -G0 1 -G1 1 -G5 1 -G6 0.0 -G7 1.0 \
../../ODE_CASES_1-LXVnW_RANDOM_INITIAL_CONDITION_$1 -R0 $2 -S0 19 -n 2 -v0 3 -v1 5 -v2 30 -G0 1 -G1 1 -G5 1 -G6 0.0 -G7 1.0 \
                                                                         -t0 4 -t1 0.0 -t2 10000.0  -G8 1 -G9 8 -G10 1 -G11 7 -G12 1 \
-H1 5.4E-5 -H2 5.4E-5 -H3 6.7E-4 -H4 6.3E-3 -H5 1 -H6 0.05 -H7 0.00001  -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.1  -M0 0.3 -M1 0.1 -M2 0.2 -M3 0.04 -L2 3.0E4 -P0 1 -P1 0.05 \
-TP 12 -TY -1  -G14 "\(2748)" # -G14 "Parameter\(2748)space\(2748)exploration:\(2748)dynamical\(2748)regims"

#-T0 0.0 -T1 324.0 -Ti 162.0 -M0 0.15 -TI 0.15 -TM 0.45 -TF 0.15  
