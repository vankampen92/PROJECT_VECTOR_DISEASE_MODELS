...
## SOLUTION SI-XW
../ODE_RESTRICTED_JACOBIAN_SI-XW_RANDOM_INITIAL_CONDITION_$1 -R0 100 -S0 19 -n 2 -v0 3 -v1 5 -t0 2000 -t1 0.0 -t2 5000.0 -H1 1.5E-5 -H2 1.5E-5 -H3 6.7E-4 -H4 0.01 -H5 0 -H7 0.00005 -M0 0.33 -M1 0.1 -M2 0.05 -M3 0.05 -M9 0.6 -P0 0 -TP 12 -TY -1 #-T0 0.0 -T1 324.0 -Ti 162.0 -M0 0.15 -TI 0.15 -TM 0.45 -TF 0.15  
