...
## SOLUTION SI-XW
## ../../ODE_RESTRICTED_JACOBIAN_NO_CASES-LXVnW_RANDOM_INITIAL_CONDITION_$1 -R0 $2 -S0 19 -n 2 -v0 3 -v1 5 -v2 30 -G0 1 -G1 1 -G5 1 -G6 0.0 -G7 1.0 \
../../ODE_NO_CASES-LXVnW_RANDOM_INITIAL_CONDITION_$1 -R0 $2 -S0 19 -n 2 -v0 3 -v1 5 -v2 30 -G0 1 -G1 1 -G5 1 -G6 0.0 -G7 1.0 \
