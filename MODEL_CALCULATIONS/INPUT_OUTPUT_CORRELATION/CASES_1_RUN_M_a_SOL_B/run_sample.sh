...
### 1D_SCAN Final Integration time -t2 32400; Forcing Period -L4 1080.0 (3y)
../CASES_1$1 -G5 0 -G6 0.0 -G7 1.0 -S0 19 -S3 50 -S4 12 -S5 0.1 -S6 2.0 -n 3 -v0 15 -v1 3 -v2 21 -G0 1 -G1 3 -t0 1441 -t1 0.0 -t2 10800 \
 -H2 1.4E-4 -H3 3.0E-3 -H4 9.0E-3 -H5 5 -H6 0.05 -H7 0.00001   -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.2    -M0 0.3 -M1 0.8 -M2 0.2 -M3 0.06 -L2 8.0E3 -L4 360.0   -P0 10 -P1 0.083 
