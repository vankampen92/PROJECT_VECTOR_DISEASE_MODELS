...
### 1D_SCAN
../CASES_1_$1 -G5 0 -G6 0.0 -G7 1.0 -S0 19 -S3 400 -S4 12 -S5 0.1 -S6 0.5 -n 3 -v0 15 -v1 3 -v2 21 -G0 1 -G1 3 -t0 1441 -t1 0.0 -t2 10800 \
-H2 1.4E-4 -H3 6.7E-4 -H4 6.3E-3 -H5 1 -H6 0.05 -H7 0.00001  -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.1  -M0 0.3 -M1 0.5 -M2 0.2 -M3 0.04 -L2 4.0E4 -P0 1 -P1 0.05
