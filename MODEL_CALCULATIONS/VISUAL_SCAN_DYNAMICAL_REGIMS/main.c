...
/* /* This code produces 2D plots through scanning a parameter subspace defined by 
   ...
   Execution:
   ~$: ./SUPERINFECTION_CASES_1-LXVnW_PR_19p -H2 1.4E-4 -H3 6.7E-4 -H4 6.3E-3 -H5 1 -H6 0.05 -H7 0.00001  -C0 0.2 -C1 0.2 -C2 0.01 -C3 0.1  -M0 0.3 -M1 0.5 -M2 0.2 -M3 0.04 -L2 3.0E4 -P0 1 -P1 0.05  -S0 19 -n 2 -v0 3 -G0 1 -G1 1 -G13 0 -G14 "Parameter\(2748)space\(2748)exploration:\(2748)dynamical\(2748)regims"
*/
...
#include "default.c"    
  /* Extra default values */
   ...
   int Input_Parameter_2 = 25;  /* (K_0, 25) (H_Gamma, 6) (H_Recov_0, 4) */
...
/* BEGIN : 2D GRID cpgplot representation */
  ...
  */
  ...
  color_Index =    1;   type_of_Line =   2;   type_of_Width =  3;  type_of_Symbol = 4;
  C_P_G___P_L_O_T_T_I_N_G___E_X_T_R_A___L_I_N_E (0.15, 1.2E4, 0.45, 1.2E4, 
  //C_P_G___P_L_O_T_T_I_N_G___E_X_T_R_A___L_I_N_E (0.15, 1.0E-3, 0.45, 1.0E-3, 
						 color_Index,
						 type_of_Line,
						 type_of_Width,
						 type_of_Symbol);
  
  color_Index =    4;   type_of_Line =   2;   type_of_Width =  3;  type_of_Symbol = 4;
  C_P_G___P_L_O_T_T_I_N_G___E_X_T_R_A___L_I_N_E (0.15, 4.0E4, 0.45, 4.0E4, 
  //C_P_G___P_L_O_T_T_I_N_G___E_X_T_R_A___L_I_N_E (0.15, 2.6E-3, 0.45, 2.6E-3, 
						 color_Index,
						 type_of_Line,
						 type_of_Width,
						 type_of_Symbol);
